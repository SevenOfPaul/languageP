 ...
 * @param {string} bytes
 */
export function run_program(bytes) {
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_appendtooutput_f4cf948a8bb19842 = function(arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('./wasm/p_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
